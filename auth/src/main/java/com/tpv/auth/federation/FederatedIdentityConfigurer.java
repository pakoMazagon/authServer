...
public final class FederatedIdentityConfigurer extends AbstractHttpConfigurer<FederatedIdentityConfigurer, HttpSecurity> {
	...
	/**
	 * @param loginPageUrl
	 *            The URL of the login page, defaults to {@code "/login"}
	 ...
	 *            The authorization request URI for initiating the login flow with
	 *            an external IDP, defaults to
	...
	/**
	 * @param oauth2UserHandler
	 *            The {@link Consumer} for performing JIT account provisioning with
	 *            an OAuth 2.0 IDP
	 * @return This configurer for additional configuration
	 */
	...
	/**
	 * @param oidcUserHandler
	 *            The {@link Consumer} for performing JIT account provisioning with
	 *            an OpenID Connect 1.0 IDP
	 * @return This configurer for additional configuration
	 */
    ...
    public void init(HttpSecurity http) throws Exception {
        ...
        final FederatedIdentityAuthenticationEntryPoint authenticationEntryPoint =
